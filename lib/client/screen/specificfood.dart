  ...
  void checkIfFaved() async {
    ...
    if (user != null) {
      ...
      if (snapshot.value != null) {
        ...
        String itemID = widget.todayMenu['itemID'];
      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            int ratesLength = specfood['rates']?.length ?? 0;
            var rated = ratesLength > 0
                ? specfood['rates'].values.reduce((a, b) => a + b) / ratesLength
                : 0.0;
            ...
            void addToCart() async {
              ...
              if (user != null) {
                try {
                  ...
                  await orderRef.set({
                    "itemID": specfood['itemID'],
                    "orderedID": orderRef.key,
                    "customerID": cusID,
                    "stallID": specfood['stallID'],
                    "totalPrice": specfood['itemPrice'],
                    "quantity": 1.toString(),
                  });
            ...
            void removeFave() async {
              User? user = _auth.currentUser;
              if (user != null) {
                var itemID = widget.todayMenu['itemID'];
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: SizedBox(
                    ...
                    child: AddOnsQuery(specfood['itemID']),
                  ),
                ),
                Positioned(
                  bottom: 0,
